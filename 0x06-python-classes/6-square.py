...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        elif (position[0] is None or position[0] is not int):
            raise TypeError("position must be a tuple of 2 positive integers")
        elif (position[0] is None or position[1] is not int):
            raise TypeError("position must be a tuple of 2 positive integers")
    ...
    def position(self, value):
        if type(value) is not tuple:
            raise TypeError("position must be a tuple of 2 positive integers")
        elif (value[0] is None or value[0] is not int):
            raise TypeError("position must be a tuple of 2 positive integers")
        elif (value[0] is None or value[1] is not int):
            raise TypeError("position must be a tuple of 2 positive integers")
